...
def argparser(prefix=None, method=None, batch_size=50, epochs=20, 
    ...
    parser.add_argument('--schedule_length', type=int, default=1)
    ...
    parser.add_argument('--type', default='binary')
    parser.add_argument('--category', default=None)
    parser.add_argument('--tuning', default='coarse')
